...
# Класс состояний обработки сообщений при выполнении задачки "на прокачку"
...
# Класс состояний обработки сообщений при нажатии текстовой кнопки Настройки
class Sett(StatesGroup):
    Stage1 = State()  # Пользователь должен ввести номер измененяемого параметра, бот задает по нему вопрос
    Stage2 = State()  # Пользователь должен ввести значение измененяемого параметра, бот проверка+запись и в Start:Wait
