...
async def answer_08_01(message: Message, state: FSMContext):
    ...
    if s == "Выполнить сейчас!":
        await message.answer("Посмотри на этот список из восьми эмоций:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5."
                             " Интерес\n6. Доверие\n7. Отвращение\n8. Удивление\nТвоя задача – определить, какое событи"
                             "е может являться причиной той или иной эмоции. Я уверен, ты справишься!\n\nИтак, какую эм"
                             "оцию ты, скорее всего, почувствуешь при: угрозе? (ответь вводом цифры от 1 до 8)",
                             reply_markup=pool)
...
async def answer_08_02(message: Message, state: FSMContext):
    ...
    if d == 4:
        ...
        await message.answer("{}, большинство людей ответили бы, что это причина <b><i>страха</i></b> (цифра 4)"
                             ".".format(name_user))
    await message.answer("{}, какую эмоцию:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5. Интерес\n6. Доверие\n7. Отв"
                         "ращение\n8. Удивление\nты, скорее всего, почувствуешь при: утрате или потере? (ответь вводом "
...
async def answer_08_03(message: Message, state: FSMContext):
    ...
    if d == 3:
        ...
        await message.answer("{}, большинство людей ответили бы, что это причина <b><i>печали</i></b> (цифра 3)"
                             ".".format(name_user))
    await message.answer("{}, какую эмоцию:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5. Интерес\n6. Доверие\n7. Отв"
                         "ращение\n8. Удивление\nты, скорее всего, почувствуешь при: отторжении вещей, людей? (ответь в"
                         "водом цифры от 1 до 8)".format(name_user))
    await Task08.next()
...
async def answer_08_04(message: Message, state: FSMContext):
    ...
    if d == 7:
        ...
        await message.answer("{}, большинство людей ответили бы, что это причина <b><i>отвращения</i></b> (цифра 7)"
                             ".".format(name_user))
    await message.answer("{}, какую эмоцию:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5. Интерес\n6. Доверие\n7. Отв"
                         "ращение\n8. Удивление\nты, скорее всего, почувствуешь при: получении чего-то желаемого? (отве"
...
async def answer_08_05(message: Message, state: FSMContext):
    ...
    if d == 2:
        ...
        await message.answer("{}, большинство людей ответили бы, что это причина <b><i>радости</i></b> (цифра 2)"
                             ".".format(name_user))
    await message.answer("{}, какую эмоцию:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5. Интерес\n6. Доверие\n7. Отв"
                         "ращение\n8. Удивление\nты, скорее всего, почувствуешь при: получении новой нужной информации?"
...
async def answer_08_06(message: Message, state: FSMContext):
    ...
    if d == 5:
        ...
        await message.answer("{}, большинство людей ответили бы, что это причина <b><i>интереса</i></b> (цифра 5)"
                             ".".format(name_user))
    await message.answer("{}, какую эмоцию:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5. Интерес\n6. Доверие\n7. Отв"
                         "ращение\n8. Удивление\nты, скорее всего, почувствуешь при: появлении чего-то неожиданного? (о"
                         "тветь вводом цифры от 1 до 8)".format(name_user))
    await Task08.next()
...
async def answer_08_07(message: Message, state: FSMContext):
    ...
    if d == 8:
        ...
        await message.answer("{}, большинство людей ответили бы, что это причина <b><i>удивления</i></b> (цифра 8)"
                             ".".format(name_user))
    await message.answer("{}, какую эмоцию:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5. Интерес\n6. Доверие\n7. Отв"
                         "ращение\n8. Удивление\nты, скорее всего, почувствуешь при: принятии ситуации или слов другого"
...
async def answer_08_08(message: Message, state: FSMContext):
    ...
    if d == 6:
        ...
        await message.answer("{}, большинство людей ответили бы, что это причина <b><i>доверия</i></b> (цифра 6)"
                             ".".format(name_user))
    await message.answer("{}, какую эмоцию:\n1. Злость\n2. Радость\n3. Печаль\n4. Страх\n5. Интерес\n6. Доверие\n7. Отв"
                         "ращение\n8. Удивление\nты, скорее всего, почувствуешь при: недосягаемости желаемого, непреодо"
                         "лимом препятствии, несправедливости или отстаивании «своих границ»? (ответь вводом цифры от "
                         "1 до 8)".format(name_user))
    await Task08.next()
